...
class DailyBarRaw(Base):
    __tablename__ = "raw_daily_bar"
    ...
    __table_args__ = (
        ...
        Index("ix_raw_daily_bar_symbol_trade_date", "symbol", "trade_date"),
        Index("ix_raw_daily_bar_batch_id", "batch_id"),
        Index("ix_raw_daily_bar_sync_run_id", "sync_run_id"),
    )