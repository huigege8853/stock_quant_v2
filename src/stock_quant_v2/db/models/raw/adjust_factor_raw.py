...
from sqlalchemy import BigInteger, Date, DateTime, Index, JSON, String, UniqueConstraint
from sqlalchemy.orm import Mapped, mapped_column

from stock_quant_v2.db.base import Base


class AdjustFactorRaw(Base):
    __tablename__ = "raw_adjust_factor"
    ...
    __table_args__ = (
        UniqueConstraint(
            ...
            "dataset_code",
            "provider_record_key",
            name="uq_raw_adjust_factor_provider_key",
        ),
        Index("ix_raw_adjust_factor_symbol_trade_date", "symbol", "trade_date"),
        Index("ix_raw_adjust_factor_batch_id", "batch_id"),
        Index("ix_raw_adjust_factor_sync_run_id", "sync_run_id"),
    )