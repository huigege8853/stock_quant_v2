...
SEED_FEATURES: list[dict] = [
    ...
    {
        "feature_code": FEATURE_CODES["FEAT_INDUSTRY_STRENGTH_20"],
        "feature_name": "Feature Industry Strength 20D",
        "source_type": "derived_industry_feature",
        "source_ref_code": "SW_INDUSTRY_L1:return_20d_rank",
        "dtype": "float64",
        "fillna_policy": "none",
        "scaling_policy": "percent_rank",
        "winsorize_policy": "none",
        "availability_rule_json": {"require_sw_industry_l1": True, "window_size": 20},
        "version": "v1",
        "is_active": True,
        "description": "S1.2 行业强弱主特征：申万一级行业 20 日收益横截面 percentile rank。",
    },
    {
        "feature_code": FEATURE_CODES["FEAT_INDUSTRY_RET_20"],
        "feature_name": "Feature Industry Return 20D",
        "source_type": "derived_industry_feature",
        "source_ref_code": "SW_INDUSTRY_L1:return_20d",
        "dtype": "float64",
        "fillna_policy": "none",
        "scaling_policy": "none",
        "winsorize_policy": "none",
        ...
        "version": "v1",
        "is_active": True,
        "description": "S1.2 行业 20 日平均收益，用于解释行业强弱。",
    },
    {
        "feature_code": FEATURE_CODES["FEAT_INDUSTRY_BREADTH_20"],
        "feature_name": "Feature Industry Breadth 20D",
        "source_type": "derived_industry_feature",
        "source_ref_code": "SW_INDUSTRY_L1:positive_return_ratio_20d",
        "dtype": "float64",
        "fillna_policy": "none",
        "scaling_policy": "none",
        "winsorize_policy": "none",
        ...
        "version": "v1",
        "is_active": True,
        "description": "S1.2 行业内 20 日收益为正的股票比例，用于行业宽度解释。",
    },
    {
...
SEED_FEATURE_SET: dict = {
    ...
    "feature_codes_json": [
        ...
        FEATURE_CODES["FEAT_INDUSTRY_STRENGTH_20"],
        FEATURE_CODES["FEAT_INDUSTRY_RET_20"],
        FEATURE_CODES["FEAT_INDUSTRY_BREADTH_20"],
    ],
