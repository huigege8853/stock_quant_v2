...
class ProductionDailyObservationReportBuilder:
    ...
    def build(
        ...
        *,
        ...
        # R63X7C_LATEST_EXPLAINABILITY_ACCEPTANCE_FIX_V1: keep explainability CSV schema stable for formal latest acceptance.
        for explain_row in signal_explain_rows:
            explain_row.setdefault("report_date", resolved_report_date)
        for explain_row in trade_explain_rows:
            explain_row.setdefault("report_date", resolved_report_date)
