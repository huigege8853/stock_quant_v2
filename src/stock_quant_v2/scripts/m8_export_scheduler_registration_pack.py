...
def main() -> None:
    ...
    output_dir = env_path("M8_SCHEDULER_REG_OUTPUT_DIR", "artifacts/m8/scheduler_registration")
    ...
    try:
        result = M8SchedulerRegistrationService(session).export_scheduler_registration_pack(
