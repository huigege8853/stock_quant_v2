...
from stock_quant_v2.trading_domain.tasks.simulate_rebalance_fills import (
    run_simulate_rebalance_fills,
)
...
def main() -> None:
    ...
    try:
        root_run = run_repo.create_run(
            ...
            run_name="bootstrap_m7_paper_rebalance_fill_chain",
            trigger_type="MANUAL",
            context_json={
                "module": "M7",
                "stage": "M7.3-A",
                "purpose": "paper_rebalance_fill_simulation",
        ...
        result = run_simulate_rebalance_fills(
            session=session,
            fill_run_id=root_run.id,
            order_run_id=order_run_id,
            portfolio_id=portfolio_id,
        ...
        output = {
            "m7_rebalance_fill_run_id": root_run.id,
            **result,
        }
