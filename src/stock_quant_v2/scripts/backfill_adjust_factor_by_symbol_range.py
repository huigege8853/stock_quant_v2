...
from stock_quant_v2.data_domain.tasks.backfill_adjust_factor_by_symbol_range import (
    run_backfill_adjust_factor_by_symbol_range,
)
    ...
    try:
        ...
        with SessionLocal() as session:
            ...
            run_backfill_adjust_factor_by_symbol_range(
                ...
                resume_enabled=settings.adjust_factor_resume_enabled,
                force_rerun=settings.adjust_factor_force_rerun,
                max_reconnect_attempts=settings.adjust_factor_max_reconnect_attempts,
                reconnect_sleep_seconds=settings.adjust_factor_reconnect_sleep_seconds,
                fail_fast=settings.adjust_factor_fail_fast,
            )
    finally:
        dispose_engine()
