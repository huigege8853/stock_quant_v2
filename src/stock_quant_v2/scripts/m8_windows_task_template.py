...
def main() -> None:
    ...
    output_dir = env_path("M8_SCHEDULER_TEMPLATE_OUTPUT_DIR", "artifacts/m8/scheduler")
    report_output_dir = env_path("M8_REPORT_OUTPUT_DIR", "artifacts/m8/daily_ops")
    ...
    try:
        result = M8SchedulerService(session).generate_windows_task_template(
